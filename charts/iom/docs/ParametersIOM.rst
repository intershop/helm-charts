...
+----------------------------------------+------------------------------------------------------------------------------------------------+---------------------------------------------------------+
|kubectlImageRepository                  |Repository of the kubectl image.                                                                |bitnami/kubectl:1.32.1                                   |
|                                        |We recommend to change this to 'ishpwa.azurecr.io/bitnami/kubectl' for any systems hosted by    |                                                         |
|                                        |Intershop.                                                                                      |                                                         |
+----------------------------------------+------------------------------------------------------------------------------------------------+---------------------------------------------------------+
