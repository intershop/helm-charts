...
..
   ...
   +-------------+-----+-----+-----+-----+-----+-----+-------+-------+-------+-------+
   |Helm / IOM   |3.5  |3.6  |3.7  |4.0  |4.1  |4.2  |4.3-4.7|5.0    |5.1    |6.1    |
   |             |     |     |     |     |     |     |       |       |       |       |
   +=============+=====+=====+=====+=====+=====+=====+=======+=======+=======+=======+
   |**3.2**      |x    |x    |x    |[3]_ |[3]_ |[3]_ |[4]_   |[5]_   |[6]_   |       |
   |             |     |     |     |[4]_ |[4]_ |[4]_ |[6]_   |[6]_   |       |       |
   |             |     |     |     |[6]_ |[6]_ |[6]_ |       |       |       |       |
   +-------------+-----+-----+-----+-----+-----+-----+-------+-------+-------+-------+
   ...
   .. [6] Helm parameters for *secret custom credentials* do not work in this combination.
