...
Configures if and how an https://kubernetes.io/docs/concepts/services-networking/ingress/[ingress] configuration is deployed that points to use for the `icm-as-wa` service. The following table lists the attributes of the `ingress` section:
