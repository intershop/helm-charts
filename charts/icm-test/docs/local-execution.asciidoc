...
When running a job server test, it is necessary to create the ICMJob custom resource before running the test. It is defined in the icm-job chart and be created using the following command:
