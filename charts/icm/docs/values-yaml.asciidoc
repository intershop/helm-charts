...
|kubernetes-ingress|https://github.com/haproxytech/kubernetes-ingress[HAProxy Ingress controller] (for development/testing purposes)|https://haproxytech.github.io/helm-charts[kubernetes-ingress documentation]
