...
| ------ | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.11.0 | 1.0.0  | <ul><li>Add option to enable/disable cache init container</li><li>Introduce cache container reset after deployment via hook job</li><li>Provide option to change the `redis-cli` image for the cache flush job</li></ul>                                                                                                                                                                                                                | The cache init container image is now provided in the format<br/>`image: busybox:1.37`<br/>instead of<br/>`image:`<br/>&nbsp;&nbsp;`repository: busybox`<br/>&nbsp;&nbsp;`tag: 1.37`                                                                                                            |
...
| `cache.init`              | Specify settings for the init container                                    | `init:`<br>&nbsp;&nbsp;`enabled: true`<br>&nbsp;&nbsp;`image: busybox:1.37`                           |
...
| `image`   | Docker image containing `kubectl` for executing the restart command | `ishcp.azurecr.io/ishops/cronjob-utils:1.0.0` |
