...
Configures the readiness, liveness and startup https://kubernetes.io/docs/concepts/configuration/liveness-readiness-startup-probes/[probes] for the `icm-as-server` container. The following table lists the attributes of the `probes` section:
